...
export function useLocationActions() {
    ...
    const handleLocationPermissionsBtn = async () => {
        ...
        if
            ...
            return navigateTo({ name: 'weather-coordinates', params: { coordinates: `${location.latitude},${location.longitude}` } })
    ...
    const handleSearchSelect = async (res: any) => {
        if (res) {
            ...
            if
                ...
                return navigateTo({ name: 'weather-coordinates', params: { coordinates: `${newUserLocation.latitude},${newUserLocation.longitude}` } })
            }
